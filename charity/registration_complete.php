        ...
        <div class="w-50 mx-auto card card-body">
            ...
            <form method="POST" action="registration_complete.php">
                <div class="form-group">
                    <label for="name"><?php echo c_CharityName ?></label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="<?php echo c_EnterCharityName ?>" required>
                </div>
                <div class="form-group">
                    <label for="year"><?php echo c_EstablishedYear ?></label>
                    <input type="number" class="form-control" name="year" id="year" placeholder="<?php echo c_EnterEstablishedYear ?>" required>
                </div>
                <div class="form-group">
                    <label for="number"><?php echo c_NumberOfPeopleCovered ?></label>
                    <input type="number" class="form-control" name="number" id="number" placeholder="<?php echo c_EnterNumberOfPeopleCovered ?>" required>
                </div>
